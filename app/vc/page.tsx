...
import SourcesEvidence from "@/components/vc/sources-evidence"
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-8">
      ...
      <header className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-pretty">Analyst Report</h1>
        <p className="text-sm text-muted-foreground">
          Structured, auditable view of the company using extracted founder inputs, public data, and peer benchmarks.
          This page compiles everything into a single printable report with provenance and trust checks.
        </p>
        ...
        <nav aria-label="Report contents" className="mt-3">
          <ul className="flex flex-wrap gap-3 text-sm text-muted-foreground">
            <li>
              <Link href="#snapshot" className="underline-offset-2 hover:underline">
                Snapshot
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="#frameworks" className="underline-offset-2 hover:underline">
                Frameworks & Score
              </Link>
            </li>
            <li>
              <Link href="#risks" className="underline-offset-2 hover:underline">
                Risks
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="#report" className="underline-offset-2 hover:underline">
                Report
              </Link>
            </li>
          </ul>
