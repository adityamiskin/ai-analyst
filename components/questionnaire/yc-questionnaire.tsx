...
export function YCQuestionnaire() {
  ...
  const addFounder = () => {
    setData((d) => ({
      ...
      team: {
        ...d.team,
        founders: [...d.team.founders, { name: "", email: "", designation: "" }],
      },
    }))
  }
  ...
  const updateFounder = (index: number, field: keyof Founder, value: string) => {
    setData((d) => ({
      ...
      team: {
        ...d.team,
        founders: d.team.founders.map((founder, i) => (i === index ? { ...founder, [field]: value } : founder)),
      },
    }))
  }
      ...
      <Tabs defaultValue="company" className="space-y-6">
        ...
        <TabsContent value="company" className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Basics and your one-liner. Upload your pitch deck here so investors can review context alongside answers.
          </p>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, company: { ...d.company, name: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, company: { ...d.company, website: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, company: { ...d.company, location: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              <Label>Stage</Label>
              <Select
                ...
                onValueChange={(v) => setData((d) => ({ ...d, company: { ...d.company, stage: v } }))}
              >
                <SelectTrigger>
            ...
            <div className="grid gap-2 md:col-span-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, company: { ...d.company, oneLiner: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2 md:col-span-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, company: { ...d.company, whatDoYouDo: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2 md:col-span-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, company: { ...d.company, whyNow: e.target.value } }))}
              />
            </div>
          </div>
          ...
          <div className="grid gap-2">
            <FilePicker
              ...
              accept=".pdf,.ppt,.pptx"
              onPicked={(files) => setData((d) => ({ ...d, company: { ...d.company, deck: files } }))}
            />
        ...
        <TabsContent value="documents" className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Upload your key documents first. These help provide context for the rest of your application.
          </p>
          <div className="grid gap-6">
            <div className="grid gap-2">
              <FilePicker
                ...
                accept=".xlsx,.csv,.pdf"
                onPicked={(files) => setData((d) => ({ ...d, documents: { ...d.documents, financialModel: files } }))}
              />
            ...
            <div className="grid gap-2">
              <FilePicker
                ...
                accept=".xlsx,.csv,.pdf"
                onPicked={(files) => setData((d) => ({ ...d, documents: { ...d.documents, capTable: files } }))}
              />
            ...
            <div className="grid gap-2">
              <FilePicker
                ...
                accept=".pdf"
                onPicked={(files) => setData((d) => ({ ...d, documents: { ...d.documents, incorporation: files } }))}
              />
            ...
            <div className="grid gap-2">
              <FilePicker
                ...
                onPicked={(files) => setData((d) => ({ ...d, documents: { ...d.documents, other: files } }))}
              />
        ...
        <TabsContent value="team" className="space-y-4">
          <p className="text-sm text-muted-foreground">Who's building this and how you work together.</p>
                    ...
                    <div className="grid gap-3 md:grid-cols-3">
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => updateFounder(index, "designation", e.target.value)}
                          placeholder="CEO"
                        />
                      </div>
                    </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                onCheckedChange={(v) => setData((d) => ({ ...d, team: { ...d.team, isFullTime: Boolean(v) } }))}
              />
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, team: { ...d.team, howLongWorked: e.target.value } }))}
              />
            </div>
          </div>
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              onChange={(e) => setData((d) => ({ ...d, team: { ...d.team, relevantExperience: e.target.value } }))}
            />
          </div>
        </TabsContent>

        <TabsContent value="product" className="space-y-4">
          <p className="text-sm text-muted-foreground">Describe the product and share visuals or demos.</p>
          <div className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, product: { ...d.product, description: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, product: { ...d.product, demoUrl: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, product: { ...d.product, videoUrl: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              <FilePicker
                ...
                multiple={false}
                onPicked={(files) => setData((d) => ({ ...d, product: { ...d.product, videoFile: files } }))}
              />
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, product: { ...d.product, defensibility: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              <FilePicker
                ...
                onPicked={(files) => setData((d) => ({ ...d, product: { ...d.product, supportingDocs: files } }))}
              />
        ...
        <TabsContent value="market" className="space-y-4">
          <p className="text-sm text-muted-foreground">Customers, competitors, and how big this can be.</p>
          <div className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, customer: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, competitors: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, differentiation: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, gtm: e.target.value } }))}
              />
            </div>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, tam: e.target.value } }))}
                />
              </div>
              <div className="grid gap-2">
                <Label>SAM (USD)</Label>
                <Input
                  ...
                  onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, sam: e.target.value } }))}
                />
              </div>
              <div className="grid gap-2">
                <Label>SOM (USD)</Label>
                <Input
                  ...
                  onChange={(e) => setData((d) => ({ ...d, market: { ...d.market, som: e.target.value } }))}
                />
              </div>
            </div>
          </div>
        ...
        <TabsContent value="traction" className="space-y-4">
          <p className="text-sm text-muted-foreground">Share measurable progress and attach data if helpful.</p>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="grid gap-2">
              <Label>Have you launched?</Label>
              <Select
                value={data.traction.isLaunched}
                onValueChange={(v) => setData((d) => ({ ...d, traction: { ...d.traction, isLaunched: v } }))}
              >
                <SelectTrigger>
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, traction: { ...d.traction, launchDate: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              <Label>MRR (USD)</Label>
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, traction: { ...d.traction, mrr: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setData((d) => ({ ...d, traction: { ...d.traction, growth: e.target.value } }))}
              />
            </div>
            <div className="grid gap-2 md:col-span-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setData((d) => ({ ...d, traction: { ...d.traction, activeUsersCount: e.target.value } }))
                }
              />
            </div>
          </div>
          ...
          <div className="grid gap-2">
            <FilePicker
              ...
              accept=".csv"
              onPicked={(files) => setData((d) => ({ ...d, traction: { ...d.traction, metricsCsv: files } }))}
            />
          ...
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              onChange={(e) => setData((d) => ({ ...d, traction: { ...d.traction, pilots: e.target.value } }))}
            />
          </div>
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              onChange={(e) => setData((d) => ({ ...d, traction: { ...d.traction, kpis: e.target.value } }))}
            />
          </div>
        </TabsContent>
      </Tabs>
